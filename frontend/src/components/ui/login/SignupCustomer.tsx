...
import { ArrowLeft, User, Mail, Lock, Building, Phone, Eye, EyeOff } from 'lucide-react'
  ...
  const validate = () => {
    ...
    if (!validatePassword(form.password)) {
      showToast({
        ...
        description: 'Пароль должен содержать минимум 8 символов, 2 заглавные буквы и 3 цифры',
      })
      return false
    }
